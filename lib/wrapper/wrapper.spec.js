...
describe('Wrapper', () => {
  describe('#query', () => {
    ...
    it('throws an error if the provided zip code is too short', () => {
      return wrapper
        .query(data.ca_code_short.request)
        .catch(error => {
          error.should.deep.equal(new Error('Zip code provided is too short: L6'));
        });
    });
